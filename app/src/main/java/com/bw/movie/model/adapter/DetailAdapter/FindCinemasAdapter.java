 ...
 * function:
 */
public class FindCinemasAdapter extends RecyclerView.Adapter<FindCinemasAdapter.Vh> {

    private List<FindCinemasEntity.ResultBean> mResult;

    public FindCinemasAdapter(List<FindCinemasEntity.ResultBean> result) {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_cinemas_item_layout, parent, false);
